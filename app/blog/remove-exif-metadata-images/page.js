...
export const metadata = {
  ...
  description: 'What EXIF metadata is, why you should remove it before uploading to ad platforms, and the fastest ways to strip it — online, on Mac, on Windows, and automatically.',
  alternates: { canonical: 'https://metaclean.pro/blog/remove-exif-metadata-images' },
  openGraph: {
    title: 'How to Remove EXIF Metadata from Images (2025 Guide)',
    description: 'What EXIF metadata is, why you should remove it, and the fastest ways to strip it from your images.',
    url: 'https://metaclean.pro/blog/remove-exif-metadata-images',
    type: 'article',
    ...
    <div style={{ minHeight: '100vh', background: '#060609', color: 'white', fontFamily: '-apple-system, BlinkMacSystemFont, "Helvetica Neue", sans-serif' }}>
      ...
      <article style={{ maxWidth: 720, margin: '0 auto', padding: '60px 24px 80px' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 32, fontSize: 13, color: 'rgba(255,255,255,0.3)' }}>
          ...
          <span>›</span>
          <span style={{ color: 'rgba(255,255,255,0.5)' }}>Remove EXIF Metadata</span>
        </div>
        ...
        <div style={{ background: 'linear-gradient(135deg, rgba(37,99,235,0.08), rgba(139,92,246,0.1))', border: '1px solid rgba(99,102,241,0.2)', borderRadius: 16, padding: '32px 36px', textAlign: 'center' }}>
          <h2 style={{ fontSize: 22, fontWeight: 700, letterSpacing: '-0.5px', marginBottom: 10, marginTop: 0 }}>Strip metadata from your ad images in seconds.</h2>
          <p style={{ fontSize: 15, color: 'rgba(255,255,255,0.5)', marginBottom: 24, lineHeight: 1.6 }}>EXIF, GPS, IPTC, XMP — all removed. Plus resize to every ad platform format automatically.</p>
