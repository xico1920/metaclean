...
export const metadata = {
  ...
  description: 'Every Facebook and Instagram ad image size in one place — Feed, Stories, Reels, Carousel, and Collection. Plus file size limits and how to resize automatically.',
  alternates: { canonical: 'https://metaclean.pro/blog/meta-ads-image-size' },
  openGraph: {
    title: 'Meta Ads Image Sizes: The Complete 2025 Guide',
    description: 'Every Facebook and Instagram ad image size in one place — Feed, Stories, Reels, Carousel, and Collection.',
    url: 'https://metaclean.pro/blog/meta-ads-image-size',
    type: 'article',
    ...
    <div style={{ minHeight: '100vh', background: '#060609', color: 'white', fontFamily: '-apple-system, BlinkMacSystemFont, "Helvetica Neue", sans-serif' }}>
      ...
      <article style={{ maxWidth: 720, margin: '0 auto', padding: '60px 24px 80px' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 32, fontSize: 13, color: 'rgba(255,255,255,0.3)' }}>
          ...
          <span>›</span>
          <span style={{ color: 'rgba(255,255,255,0.5)' }}>Meta Ads Image Sizes</span>
        </div>
        ...
        <div style={{
          ...
          <p style={{ fontSize: 15, color: 'rgba(255,255,255,0.5)', marginBottom: 24, lineHeight: 1.6 }}>
            Upload once, get all Meta ad formats in one ZIP — with metadata stripped. Free, no account needed.
          </p>
          <Link href="/dashboard" style={{
            display: 'inline-block',
            padding: '13px 28px',
