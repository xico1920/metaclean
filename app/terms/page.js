  ...
  return (
    <Link href="/" style={{display:'flex', alignItems:'center', gap:'10px', textDecoration:'none'}}>
      <svg width="32" height="32" viewBox="0 0 56 56" fill="none">
        <defs><clipPath id="iconClip4"><rect width="56" height="56" rx="13"/></clipPath></defs>
        <rect width="56" height="56" rx="13" fill="#4338ca"/>
        <g clipPath="url(#iconClip4)">
  ...
  return (
    <main className="min-h-screen bg-[#060609] text-white" style={{fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif'}}>
      ...
      <div className="max-w-2xl mx-auto px-6 pt-16 pb-32">
        <div className="mb-12">
          <p className="text-[11px] text-gray-500 uppercase tracking-widest mb-3">Legal</p>
          <h1 className="text-3xl font-bold tracking-tight mb-2">Terms of Service</h1>
          <p className="text-gray-500 text-sm">Last updated: January 2025</p>
        </div>

        <div className="space-y-10 text-[14px] leading-relaxed text-gray-400">
          {[
            ...
            <div key={idx}>
              <h2 className="text-white font-semibold text-[15px] mb-3">{s.title}</h2>
              <p>{s.body}</p>
            </div>
          ))}
        </div>
      ...
      <footer className="border-t border-white/5 px-8 py-6 flex items-center justify-between max-w-2xl mx-auto">
        <Logo />
