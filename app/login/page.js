...
export default function Login() {
  ...
  return (
    <main className="min-h-screen bg-[#060609] text-white flex" style={{fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif'}}>
          ...
          <div className="w-full max-w-[360px]">
            ...
            <div style={fadeIn(100)}>
              ...
              <button
                ...
                onMouseLeave={e => { e.currentTarget.style.background = 'transparent'; e.currentTarget.style.color = ''; e.currentTarget.style.borderColor = 'rgba(255,255,255,0.07)' }}
              >
